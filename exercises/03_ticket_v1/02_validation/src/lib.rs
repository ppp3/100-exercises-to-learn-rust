...
impl Ticket {
    ...
    //   - The `title` and `description` fields should not be empty. fertig
    //   - the `title` should be at most 50 bytes long. fertig
    //   - the `description` should be at most 500 bytes long. fertig
